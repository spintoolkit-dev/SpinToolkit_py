...
``` shell
docker pull ghcr.io/spintoolkit-dev/spintoolkit:1.6.2
```
...
docker tag ghcr.io/spintoolkit-dev/spintoolkit:1.6.2 spintoolkit:1.6.2

# Remove the reference to the long name to clean up list
docker rmi ghcr.io/spintoolkit-dev/spintoolkit:1.6.2
```
...
>
> **Note 4**: To download to Apptainer: `apptainer pull docker://ghcr.io/spintoolkit-dev/spintoolkit:1.6.2`
